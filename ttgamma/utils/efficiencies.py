...
eleIDfiles = {
    2016: "ScaleFactors/MuEGammaScaleFactors/ele2016/2016LegacyReReco_ElectronTight_Fall17V2.root",
...
eleRecofiles = {
    2016: "ScaleFactors/MuEGammaScaleFactors/ele2016/egammaEffi.txt_EGM2D_runBCDEF_passingRECO.root",
...
muSFFiles = {
    2016: [
        {
            "id": (
                "ScaleFactors/MuEGammaScaleFactors/mu2016/EfficienciesStudies_2016_legacy_rereco_rootfiles_RunBCDEF_SF_ID.root",
                "NUM_TightID_DEN_genTracks_eta_pt",
            ),
            "iso": (
                "ScaleFactors/MuEGammaScaleFactors/mu2016/EfficienciesStudies_2016_legacy_rereco_rootfiles_RunBCDEF_SF_ISO.root",
                "NUM_TightRelIso_DEN_TightIDandIPCut_eta_pt",
            ),
            "trig": (
                "ScaleFactors/MuEGammaScaleFactors/mu2016/EfficienciesStudies_2016_trigger_EfficienciesAndSF_RunBtoF.root",
        ...
        {
            "id": (
                "ScaleFactors/MuEGammaScaleFactors/mu2016/EfficienciesStudies_2016_legacy_rereco_rootfiles_RunGH_SF_ID.root",
                "NUM_TightID_DEN_genTracks_eta_pt",
            ),
            "iso": (
                "ScaleFactors/MuEGammaScaleFactors/mu2016/EfficienciesStudies_2016_legacy_rereco_rootfiles_RunGH_SF_ISO.root",
                "NUM_TightRelIso_DEN_TightIDandIPCut_eta_pt",
            ),
            "trig": (
                "ScaleFactors/MuEGammaScaleFactors/mu2016/EfficienciesStudies_2016_trigger_EfficienciesAndSF_RunGtoH.root",
                "IsoMu24_OR_IsoTkMu24_PtEtaBins/abseta_pt_ratio",
            ),
    ...
    2017: [
        {
            "id": (
                "ScaleFactors/MuEGammaScaleFactors/mu2017/RunBCDEF_SF_ID.root",
                "NUM_TightID_DEN_genTracks_pt_abseta",
            ),
            "iso": (
                "ScaleFactors/MuEGammaScaleFactors/mu2017/RunBCDEF_SF_ISO.root",
                "NUM_TightRelIso_DEN_TightIDandIPCut_pt_abseta",
            ),
            "trig": (
                "ScaleFactors/MuEGammaScaleFactors/mu2017/EfficienciesAndSF_RunBtoF_Nov17Nov2017.root",
    ...
    2018: [
        {
            "id": (
                "ScaleFactors/MuEGammaScaleFactors/mu2018/EfficienciesStudies_2018_rootfiles_RunABCD_SF_ID.root",
                "NUM_TightID_DEN_TrackerMuons_pt_abseta",
            ),
            "iso": (
                "ScaleFactors/MuEGammaScaleFactors/mu2018/EfficienciesStudies_2018_rootfiles_RunABCD_SF_ISO.root",
                "NUM_TightRelIso_DEN_TightIDandIPCut_pt_abseta",
            ),
            "trig": (
                "ScaleFactors/MuEGammaScaleFactors/mu2018/EfficienciesStudies_2018_trigger_EfficienciesAndSF_2018Data_BeforeMuonHLTUpdate.root",
        ...
        },
        {
            ...
            "trig": (
                "ScaleFactors/MuEGammaScaleFactors/mu2018/EfficienciesStudies_2018_trigger_EfficienciesAndSF_2018Data_AfterMuonHLTUpdate.root",
                "IsoMu24_PtEtaBins/abseta_pt_ratio",
            ),
...
def getEleSF_lookups(year):
    ...
    ele_id_sf = dense_lookup.dense_lookup(
        ele_id_file["EGamma_SF2D"].values, ele_id_file["EGamma_SF2D"].edges
    )
    ele_id_err = dense_lookup.dense_lookup(
        ele_id_file["EGamma_SF2D"].variances ** 0.5, ele_id_file["EGamma_SF2D"].edges
    )

    ele_reco_file = uproot.open(eleRecofiles[year])
    ele_reco_sf = dense_lookup.dense_lookup(
        ele_reco_file["EGamma_SF2D"].values, ele_reco_file["EGamma_SF2D"].edges
    )
    ele_reco_err = dense_lookup.dense_lookup(
        ele_reco_file["EGamma_SF2D"].variances ** 0.5,
...
def getEleSF(pt, eta, year, split=False):
    ...
    if not split:
        ...
        return (
            totalSF.prod(),
            totalSF_ID_up.prod(),
            totalSF_ID_down.prod(),
            totalSF_RECO_up.prod(),
            totalSF_RECO_down.prod(),
        )
...
def getMuSF_lookups(year):
    ...
    for scaleFactors in muSFFileList[1:]:
        ...
        trig_err += (
            trig_file[scaleFactors["trig"][1]].variances ** 0.5 * scaleFactors["scale"]
        )
...
def getMuSF(pt, eta, year, split=False):
    ...
    if not split:
        ...
        return (
            ...
            totalSF_ID_down.prod(),
            totalSF_Iso_up.prod(),
            totalSF_Iso_down.prod(),
            totalSF_Trig_up.prod(),
            totalSF_Trig_down.prod(),
        )
