...
muSFFileList = [
    {
        "id": (
            f"mu2016/EfficienciesStudies_2016_legacy_rereco_rootfiles_RunBCDEF_SF_ID.root",
            "NUM_Tigh\
tID_DEN_genTracks_eta_pt",
        ),
        "iso": (
            f"mu2016/EfficienciesStudies_2016_legacy_rereco_rootfiles_RunBCDEF_SF_ISO.root",
            "NUM_Ti\
ghtRelIso_DEN_TightIDandIPCut_eta_pt",
        ),
        "trig": (
            f"mu2016/EfficienciesStudies_2016_trigger_EfficienciesAndSF_RunBtoF.root",
            "IsoMu24_OR_I\
soTkMu24_PtEtaBins/abseta_pt_ratio",
    ...
    {
        "id": (
            f"mu2016/EfficienciesStudies_2016_legacy_rereco_rootfiles_RunGH_SF_ID.root",
            "NUM_Tight\
...
ele_reco_err = dense_lookup.dense_lookup(
    ele_reco_file["EGamma_SF2D"].variances ** 0.5, ele_reco_file["EGamma_SF2D"].edges
)
